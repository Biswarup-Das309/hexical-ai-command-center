import { ASTDiffResult, ASTDiffNode, ScanRecord, DiffOperationType, Finding } from './hexical-types'
...
export function calculateASTDiff(
  ...
  const stack: StackFrame[] = [{ path: 'root', oldNode: previousScan.astContext, newNode: currentScan.astContext }]
...
function hasPrimitiveMutation(
  oldAst: Record<string, unknown>,
  newAst: Record<string, unknown>,
  ignoredKeysSet: Set<string>,
): boolean {

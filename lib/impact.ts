...
export function analyzeImpact(
  ...
  return {
    ...
    securityImpact:
      ...
      insight.category==="AUTHORIZATION" ||
      insight.category==="AUTHENTICATION",

    performanceImpact:
      insight.category==="CONTROL_FLOW",

    databaseImpact:
      insight.evidence.some(e=>e.toLowerCase().includes("database")),
    ...
    unaffectedAreas:[
      "Components not referenced by semantic analysis."
    ]
  };
}

export function analyzeImpactBatch(

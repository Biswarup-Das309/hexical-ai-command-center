...
const session: InternalTTYSession = {
  ...
  limits: { maxConcurrentSessions: 1, maxConcurrentExecutionsPerSession: 1, maxExecutionsPerMinute: 10, maxExecutionDurationMs: 5_000, maxSessionIdleMs: 900_000, maxSessionDurationMs: 3_600_000, maxOutputBytesPerExecution: 64_000, maxQueueDepth: 10 },
